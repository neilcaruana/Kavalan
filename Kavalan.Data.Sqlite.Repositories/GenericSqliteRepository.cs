...
namespace Kavalan.Data.Sqlite.Repositories
{
    public class GenericSqliteRepository<T> : SqlLiteDataLayer, IGenericRepository<T> where T : new()
    {
        ...
        public async Task<T?> SelectByPrimaryKeyAsync(object pkValue)
        {
            if (pkValue == null)
        ...
        public async Task<T> UpsertAsync(T entity)
        {
            ...
            return await this.SelectByPrimaryKeyAsync(entity) ?? throw new Exception("Record not found after upsert!");
        }
